...
const warehouseZones = [
  ...
  { id: "B4", status: "active", category: "Beauty", fills: 67 },
  { id: "C1", status: "active", category: "Sports", fills: 78 },
  { id: "C2", status: "active", category: "Grocery", fills: 91 },
  { id: "C3", status: "active", category: "Health", fills: 44 },
  { id: "C4", status: "inactive", category: "Garden", fills: 28 },
  { id: "D1", status: "active", category: "Office", fills: 82 },
  { id: "D2", status: "active", category: "Pet", fills: 77 },
  { id: "D3", status: "active", category: "Automotive", fills: 56 },
  { id: "D4", status: "active", category: "Tools", fills: 69 },
];
